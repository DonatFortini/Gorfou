const but_menu1 = document.getElementById('menu_1') as HTMLButtonElement;
const but_menu2 = document.getElementById('menu_2') as HTMLButtonElement;
const but_menu3 = document.getElementById('menu_3') as HTMLButtonElement;

function change(num: string): void {
